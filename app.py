...
def get_sun_times_dt(date_obj, lat, lon):
    """Returns sunrise and sunset as datetime.time objects."""
    ...
    if not raw_hilo.empty:
        ...
        while current_day <= end_date:
            ...
            def format_tide(tide_row, is_high_tide):
                ...
                # Determine inline badge highlighting
                should_highlight = (
        ...
        # Build clean raw HTML directly to prevent Pandas Styler comment leaks
