...
# --- Accurate Solar & Lunar Calculations ---
def get_sun_times_dt(date_obj, lat, lon, tz_name="America/New_York"):
    """Accurately calculates local Sunrise and Sunset times for a given date and location."""
    ...
    # Convert UTC to local datetime using zoneinfo
...
with tab_month:
    ...
    if not raw_hilo.empty:
        ...
        while current_day <= end_date:
            ...
            row_data["Sunrise"] = sr_fmt
            row_data["Sunset"] = ss_fmt
